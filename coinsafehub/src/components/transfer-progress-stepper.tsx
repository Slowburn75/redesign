...
export type TransferStep = 'amount' | 'recipient' | 'confirmation'
...
const steps: Step[] = [
  { id: 'amount', label: 'Amount', description: 'Enter transfer amount' },
  { id: 'recipient', label: 'Recipient', description: 'Choose recipient' },
  { id: 'confirmation', label: 'Done', description: 'Confirmation' },
]

interface TransferProgressStepperProps {
  currentStep: TransferStep
  onStepClick?: (step: TransferStep) => void
  allowNavigation?: boolean
}

export function TransferProgressStepper({
  currentStep,
  onStepClick,
  allowNavigation = false,
}: TransferProgressStepperProps) {
