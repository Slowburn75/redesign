...
export function DepositConfirmationStep({
  amount,
  method,
  depositReference,
  onReset,
}: DepositConfirmationStepProps) {
          ...
          <div className="space-y-3 p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-200 ml-7">
              <li className="flex items-start gap-2">
                ...
                <span>Our team will verify your payment within {method.processingTime}</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400 mt-0.5">•</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400 mt-0.5">•</span>
                <span>Funds will be automatically credited to your account</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400 mt-0.5">•</span>
                <span>Track your deposit status in transaction history</span>
              </li>
            </ul>
          </div>
